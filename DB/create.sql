...
CREATE TABLE POSITION(Item VARCHAR(60) NOT NULL,StoreID INTEGER NOT NULL, Aisle_Number INTEGER NOT NULL,Shelf_Number INTEGER NOT NULL,PIA VARCHAR(30),Comment VARCHAR(50), Filename VARCHAR(30);
